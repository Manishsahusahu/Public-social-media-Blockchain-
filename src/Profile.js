...
const projectId = "2HArAQxVP7d8hSoxz8sIfIHeqrk";
const projectSecret = "e5e506fb99f7e7f517d74cdb967ad5fb";
    ...
    const uploadToIPFS = async (event) => {
        ...
        if (typeof file !== "undefined") {
            try {
                ...
                setAvatar(
                    `https://publicsocialmedia.infura-ipfs.io/ipfs/${result.path}`
                );
            } catch (error) {
